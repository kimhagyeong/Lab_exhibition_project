...
class Options():
    def __init__(self):
        ...
        eval_arg.add_argument("--style-folder", type=str, default="./painter/images/style1",
                                help="path to style-folder")
        eval_arg.add_argument("--style-list", type=str, default="./painter/images/style_list",
        help="path to style-list")
        # eval_arg.add_argument("--output-image", type=str, default="logo_add/final.jpg",
        #                         help="path for saving the output image")
        eval_arg.add_argument("--model", default = './painter/models_1024/Epoch_3iters_120000.params', type=str,
